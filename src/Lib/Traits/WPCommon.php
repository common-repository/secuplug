...
trait WPCommon
{
    ...
    protected static function esc( $text, $type, $args = false )
    {
        $text_domain = 'securefusion';
    ...
    public static function esc__( $text, $type = 'html', $args = false )
    {
        return self::esc( $text, $type, $args );
    }



    public static function esc_e( $text, $type = 'html', $args = false )
    {
        echo self::esc( $text, $type, $args );
    }
